...
const CommentsContent = () => {
  function arrowView() {
    ...
    boxArrow.addEventListener("click", () => {
      arrowUp.classList.toggle("CommentsContent_box-lengthComments-Arrow-UpJS");
                  ...
                  <div className="CommentsContent_box-viewsComments-comment-box">
                    ...
                    <div className="CommentsContent_box-viewsComments-comment-box-description">
                      <p>
                        ...
                        Modi obcaecati, repellat deserunt quas sit corporis est
                        beatae itaque accusamus molestias
                      </p>
                    </div>
                  </div>
                </div>

          ...
          <div className="ArticleDescription_box-Article">
            ...
            <div className="ArticleDescription_box-Article-box1">
              <div className="ArticleDescription_box-Article-box1-content">
                <img src="/public/banner/slide_4.jpg" alt="" />
                <h1>Air Condition System</h1>
                <p>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Veniam voluptatem mollitia assumenda, ad et delectus! Mollitia
                  earum, hic ratione vel soluta cum, ducimus nihil veniam
                  suscipit voluptatem, ad possimus minima.
                </p>
              </div>
            </div>
            ...
            <div className="ArticleDescription_box-Article-box2-box3">
              ...
              <div className="ArticleDescription_box-Article-box2">
                <div className="ArticleDescription_box-Article-box2-content">
                  <img src="/public/banner/slide_1.jpg" alt="" />
                  <h1>Air Condition System</h1>
                  <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Veniam voluptatem mollitia assumenda, ad et delectus!
                    Mollitia earum, hic ratione vel soluta cum, ducimus nihil
                    veniam suscipit voluptatem, ad possimus minima.
                  </p>
                </div>
              </div>
              ...
              <div className="ArticleDescription_box-Article-box3">
                <div className="ArticleDescription_box-Article-box3-content">
                  <img src="/public/banner/slide_2.jpg" alt="" />
                  <h1>Air Condition System</h1>
                  <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Veniam voluptatem mollitia assumenda, ad et delectus!
